...
def plot_histogram(arr, my_title, x_axis, distribution_type, output_directory, fig_num, bins):
    ...
    fig = plt.hist(arr, alpha = 0.65, bins=bins)
    ...
    quants = [[quant_5, 0.6, 0.75, "5th"], [quant_25, 0.8, 0.95, "25th"], [quant_50, 1, 0.59, "50th"],  [quant_75, 0.8, 0.45, "75th"], [quant_95, 0.6, 0.15, "95th"]]
...
def run_distributions(lbl_directory, output_directory, domains):
    ...
    #plot_histogram(num_images_arr, "Number of Turbines", x_axis, "num_images", output_directory, 3, 50)
